...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='GFRNet', help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--dataset_mode', type=str, default='facefh', help='chooses how datasets are loaded.')
        parser.add_argument('--model', type=str, default='facefh', help='chooses which model to use. cycle_gan, pix2pix, test')
